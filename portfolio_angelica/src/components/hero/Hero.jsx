        ...
        <div className="container flex flex-col items-center px-5 py-24 mx-auto md:flex-row">
          <div className="relative flex flex-col items-center mb-16 text-center lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left md:mb-0">
            ...
            <p className="mb-8 leading-relaxed">
              Me destaco por mi pasión a el aprendizaje continuo y mi capacidad para adaptarme
              rápidamente a nuevos desafíos, aportando soluciones creativas y
              eficientes en cada proyecto. Mi enfoque se centra en la creación
              de experiencias de usuario intuitivas y optimizadas, con un fuerte
              compromiso hacia la mejora constante y la innovación.
            </p>
          </div>
          <div className="flex justify-center">
            <a href={CV} download>
              <button className="inline-flex px-6 py-2 text-white bg-pink-500 border-0 focus:outline-none hover:bg-purple-600 hover:shadow-[0_0_40px_rbg(255,165,0,0.7)] rounded-full text-lg">
                Descarga mi CV
              </button>
            </a>
          </div>
